...
public class Deezer implements Iapi{
	...
	public void retreive_token() {
		...
		client.get("https://connect.deezer.com/oauth/auth.php?app_id=171795&redirect_uri=http://localhost:8080/callback.html&perms=basic_access,email,offline_access,manage_library,listening_history");
